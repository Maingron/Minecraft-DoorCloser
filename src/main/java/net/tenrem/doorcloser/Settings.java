...
public class Settings {
    ...
    final static String serverPlatform_Key = "Server Platform";
    final static String serverPlatform_Default = "bukkit";
    public static String serverPlatform = serverPlatform_Default;
	...
	public static void GetServerPlatform() {
		Settings.serverPlatform = Bukkit.getServer().getName().toLowerCase();
		ThisPlugin.getLogger().warning(Settings.serverPlatform);
	}
}
